...
const usersReducer = (state = initialState, incomingAction: Action): InitialStateType => {
    const action = incomingAction as ActionsTypes;
...
type ActionsTypes = ToggleUserFollowActionType | SetUsersActionType |
